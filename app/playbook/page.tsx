        ...
        <main className="flex-1 pb-20 lg:pb-0">
          ...
          <div className="relative overflow-hidden shrink-0" style={{ height: 200 }}>
            ...
            <div className="relative z-10 h-full flex flex-col justify-center px-8 lg:px-12">
              ...
              <h1 style={{ fontFamily: "var(--font-heading)", color: "oklch(0.96 0.008 85)", fontSize: "clamp(32px, 4vw, 48px)", fontWeight: 700, textShadow: "0 2px 20px oklch(0 0 0 / 0.5)", lineHeight: 1.1 }}>
                Complex concepts,{" "}
